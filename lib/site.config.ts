      ...
      items: [
        {
          ...
          description: "High-performance seating solutions for ultimate comfort and posture support.",
          icon: "Chair",
        },
        {
          slug: "standing-desks",
          name: "Standing Desks",
          description: "Transition effortlessly between sitting and standing for dynamic work.",
          icon: "Desk",
        },
        {
          slug: "monitor-arms",
          name: "Monitor Arms",
          description: "Achieve optimal screen positioning for reduced neck and eye strain.",
          icon: "Monitor",
        },
        {
          slug: "keyboard-trays",
          name: "Keyboard Trays",
          description: "Improve wrist posture and free up desk space with adjustable trays.",
          icon: "Keyboard",
        },
      ],
    },
